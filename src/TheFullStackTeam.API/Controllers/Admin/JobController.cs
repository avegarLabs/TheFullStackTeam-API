...
namespace TheFullStackTeam.API.Controllers.Admin
{
    ...
    public class JobController: AdminBaseController
    {
        ...
        public async Task<IActionResult> GetAll()
            => Ok((await Mediator.Send(new ListJobsQuery())).Data);
        ...
        /// <returns></returns>
        [HttpPut("{JobId}")]
        public async Task<IActionResult> UpdateJobAdmin([FromBody] JobModel model, Guid JobId)
        {
        ...
        /// <param name="JobId"></param>
        /// <returns></returns>
        [HttpDelete("{JobId}/skill/{SkillId}")]
