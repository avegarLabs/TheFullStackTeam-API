...
namespace TheFullStackTeam.Persistence.Migrations
{
    ...
    [Migration("20230430170643_OrganizationServiceCategoryRelationShip")]
    partial class OrganizationServiceCategoryRelationShip
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.JobLanguage", b =>
                {
                    b.Property<Guid>("JobId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("JobLanguage", (string)null);
                });
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.OrganizationServiceCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OrganizationServiceCategories", (string)null);
                });
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.ProfessionalServiceCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProfessionalServiceCategories", (string)null);
                });
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.JobContractType", b =>
                {
                    b.HasOne("TheFullStackTeam.Domain.Entities.Job", "Jobs")
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.JobLanguage", b =>
                {
                    b.HasOne("TheFullStackTeam.Domain.Entities.Job", "Job")
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.OrganizationServiceCategory", b =>
                {
                    b.HasOne("TheFullStackTeam.Domain.Entities.Category", "Category")
                        .WithMany("OrganizationServiceCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TheFullStackTeam.Domain.Entities.OrganizationSevices", "OrganizationSevice")
                        .WithMany("OrganizationServiceCategories")
                    ...
                    b.Navigation("OrganizationSevice");
                });
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.ProfessionalServiceCategory", b =>
                {
                    b.HasOne("TheFullStackTeam.Domain.Entities.Category", "Category")
                        .WithMany("ProfessionalServiceCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.Skill", b =>
                {
                    b.HasOne("TheFullStackTeam.Domain.Entities.OrganizationSevices", null)
                        .WithMany("ServiceSkills")
                        .HasForeignKey("OrganizationSevicesId");

                    b.HasOne("TheFullStackTeam.Domain.Entities.Position", null)
                        .WithMany("SkillPositions")
                        .HasForeignKey("PositionId");

                    b.HasOne("TheFullStackTeam.Domain.Entities.ProfessionalSevices", null)
                        .WithMany("ServiceSkills")
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.Category", b =>
                {
                    b.Navigation("OrganizationServiceCategories");

                    b.Navigation("ProfessionalServiceCategories");
