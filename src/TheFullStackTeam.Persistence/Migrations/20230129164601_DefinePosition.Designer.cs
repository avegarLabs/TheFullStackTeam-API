...
namespace TheFullStackTeam.Persistence.Migrations
{
    ...
    [Migration("20230129164601_DefinePosition")]
    partial class DefinePosition
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.ContractType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.JobLanguague", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("LanguagueId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("LanguagueLevel")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LanguagueName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("JobLanguague", (string)null);
                });
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.Jobs", b =>
                {
                    ...
                    b.Property<string>("OrganizationMoniker")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.JobType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.SalaryType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.SkillProfessionalServices", b =>
                {
                    ...
                    b.Property<Guid>("ProfessionalServicesId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProfessionalServicesId");
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.JobContractType", b =>
                {
                    b.HasOne("TheFullStackTeam.Domain.Entities.ContractType", "ContractTypes")
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.JobsJobType", b =>
                {
                    ...
                    b.HasOne("TheFullStackTeam.Domain.Entities.JobType", "JobType")
                        .WithMany("JobsJobTypes")
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.JobsSalaryType", b =>
                {
                    ...
                    b.HasOne("TheFullStackTeam.Domain.Entities.SalaryType", "SalaryType")
                        .WithMany("JobsSalaryTypes")
            ...
            modelBuilder.Entity("TheFullStackTeam.Domain.Entities.SkillProfessionalServices", b =>
                {
                    b.HasOne("TheFullStackTeam.Domain.Entities.ProfessionalSevices", "ProfessionalSevices")
                        .WithMany("SkillProfessionalServices")
                        .HasForeignKey("ProfessionalServicesId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
